...
use windows::Win32::UI::WindowsAndMessaging::{
    EnumWindows, FindWindowExW, FindWindowW, GetClassNameW, ScreenToClient, SendMessageW, SetParent,
    HTCLIENT, HTTRANSPARENT, WM_NCHITTEST,
};
...
unsafe extern "system" fn subclass_proc(
    ...
    if msg == WM_NCHITTEST {
        ...
        let hit = if inside_circle(lx, ly) {
            HTCLIENT
        } else {
            HTTRANSPARENT
        };
